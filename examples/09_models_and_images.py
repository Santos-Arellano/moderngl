...
class Scene:
    def __init__(self):
        ...
        self.texture = ImageTexture('Obed_Munoz/moderngl/examples/data/textures/crate.png')

        self.car_geometry = ModelGeometry('Obed_Munoz/moderngl/examples/data/models/lowpoly_toy_car.obj')
        self.car = Mesh(self.program, self.car_geometry)

        self.crate_geometry = ModelGeometry('Obed_Munoz/moderngl/examples/data/models/crate.obj')
